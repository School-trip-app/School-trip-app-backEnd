...
describe('photographer Route', () => {
  it('should create a new photographer', async () => {
    const response = await request.post('/photographer').send({
      image: 'https://i.ibb.co/8X3Cq3M/photographer1.jpg',
      name: 'Ahmad',
      email: 'test@test.com',
    ...
    expect(response.body.image).toEqual('https://i.ibb.co/8X3Cq3M/photographer1.jpg');
  ...
  it('should get all photographers', async () => {
    ...
    expect(response2.body[0].image).toEqual('https://i.ibb.co/8X3Cq3M/photographer1.jpg');
